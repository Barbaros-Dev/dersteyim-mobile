                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _buildScreenTitle(
                          context,
                          screenTitle: "Login or Sign Up",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.loginOrSignUpScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Sign Up 2nd Step",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.signUp2ndStepScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Sign Up 3rd Step",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.signUp3rdStepScreen),
                        ),
                        _buildScreenTitle(
                          context,
